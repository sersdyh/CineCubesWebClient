...
public class CubeBase {
	...
	public CubeBase(String lookup) {
		...
		try {
			String line;
			Scanner scanner = new Scanner(new FileReader("InputFiles/" + lookup
					+ "/dbc.ini"));
	...
	/*
	 * Maybe need code or parameter to finding proper cube Now check the last
	 * cube in cubebase only
	 */
